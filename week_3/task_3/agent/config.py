...
class AgentConfig:
    ...
    def __post_init__(self):
        ...
        for name in ("keep_last_messages", "facts_max_keys", "facts_value_chars", "facts_output_tokens", "extraction_output_tokens", "extraction_max_operations", "validation_output_tokens", "validation_max_input_chars"):
        ...
        for name in ("model", "instructions", "limits_source", "limits_checked_at", "extraction_instructions", "validation_instructions"):
