...
from agent import load_config as application_config
from test_agent import FakeTransport, response, isolated_agent


def load_config():
    # Фиксированный тариф для независимой проверки арифметики.
    base = application_config()
    return replace(base, model="gpt-5.6-luna", pricing=replace(base.pricing,
        model="gpt-5.6-luna", input_usd_per_million="0.20",
        cached_input_usd_per_million="0.02", output_usd_per_million="1.20",
