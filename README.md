...
[Задание 1.1 — запрос к LLM через API](week_1/task_1/README.md): локальное веб-приложение на Python и Flask. Пользователь вводит вопрос в браузере, приложение отправляет его модели Luna и показывает ответ. В репозитории есть исходный код, тесты и инструкция запуска. Демонстрационные и вспомогательные материалы хранятся локально и не входят в Git.
...
[Задание 1.3 — разные способы рассуждения](week_1/task_3/README.md): задача о мосте, четыре способа через API, шесть проверенных итоговых маршрутов и сравнение. Код и реальные ответы входят в Git; видео хранится локально.
