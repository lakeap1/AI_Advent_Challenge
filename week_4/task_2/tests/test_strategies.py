...
class Fake:
    ...
    def create(self, payload, timeout):
        ...
        import copy
        result = copy.deepcopy(self.replies.pop(0) if self.replies else response())
        # Existing profile tests isolate personalization with an explicit stay.
        # RawTransport tests validate the machine envelope without this adapter.
